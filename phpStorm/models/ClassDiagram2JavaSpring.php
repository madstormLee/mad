...
class ClassDiagram2JavaSpring implements IteratorAggregate {
	...
	private $presets = array(
			"listController" => "proto/javaSpring/controllers/list.java",
			"iudController" => "proto/javaSpring/controllers/write.java",
			"viewController" => "proto/javaSpring/controllers/view.java",
			"interface" => "proto/javaSpring/models/interface.java",
			"model" => "proto/javaSpring/models/implementation.java",
			);
	private $data;
	private $views;
