package com.a2m.framework.controller;
...
public interface SimpleController {
	 ...
	 * @throws Exception
	 */
	ModelAndView doInit(HttpServletRequest request, HttpServletResponse response, Map reference) throws Exception;
	 ...
	 * @throws Exception
	 */
	ModelAndView doRequest(HttpServletRequest request, HttpServletResponse response, Map reference) throws Exception;
	 ...
	 * @throws Exception
	 */
	ModelAndView doSubmit(HttpServletRequest request, HttpServletResponse response, String mode) throws Exception;
