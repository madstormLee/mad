...
function setVal(id,nm){	
	$(opener.document).find('#chrg_id').val(id);
	$(opener.document).find('#chrg_nm').val(nm);
	window.close();
}
</script>
</head>
...
<body class="main">
	...
	<form name="form1" id="form1" method="post"  action="<%=request.getContextPath() %>/mngr/common/comm_insa01_p.do" >	
    <div id="search_list">
			<fieldset>
				<legend>직원 검색</legend>
